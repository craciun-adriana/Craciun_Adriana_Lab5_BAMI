...
namespace Craciun_Adriana_Lab5
{
    public partial class ClassificationModel
    {
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"InspectionType",outputColumnName:@"InspectionType")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.LightGbm(new LightGbmMulticlassTrainer.Options(){NumberOfLeaves=4,NumberOfIterations=800,MinimumExampleCountPerLeaf=22,LearningRate=0.9999997766729865,LabelColumnName=@"RiskCategory",FeatureColumnName=@"Features",Booster=new GradientBooster.Options(){SubsampleFraction=0.5548707019078741,FeatureFraction=0.99999999,L1Regularization=2E-10,L2Regularization=0.4780626533121616},MaximumBinCountPerFeature=206}))      
