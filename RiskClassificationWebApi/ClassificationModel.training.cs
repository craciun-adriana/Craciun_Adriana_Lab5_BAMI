...
using Microsoft.ML.Trainers.LightGbm;
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\adric\Desktop\FSEGA\Dezvoltarea de sisteme de Big Data\RESTAURANTSCORES.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"InspectionType",outputColumnName:@"InspectionType")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.LightGbm(new LightGbmMulticlassTrainer.Options(){NumberOfLeaves=1681,NumberOfIterations=34,MinimumExampleCountPerLeaf=20,LearningRate=0.8821589745485522,LabelColumnName=@"RiskCategory",FeatureColumnName=@"Features",Booster=new GradientBooster.Options(){SubsampleFraction=0.9999997766729865,FeatureFraction=0.9893001420511416,L1Regularization=2.869689767878896E-10,L2Regularization=0.6450324338829302},MaximumBinCountPerFeature=310}))      
